...
<head>
  ...
  <script src="{{ site.url }}/js/zoom.js"></script>
  <script src="{{ site.url }}/js/transition.js"></script>
  ...
  {% capture description %}{% if page.description %}{{ page.description }}{% else %}{{ content }}{% endif %}{% endcapture %}
